...
//                        NSData *imageData = [[SDImageCache sharedImageCache] diskImageDataForKey:photo.url.absoluteString];//源代码
                        NSData *imageData = [[[SDImageCache sharedImageCache] imageFromCacheForKey:photo.url.absoluteString] sd_imageData];
